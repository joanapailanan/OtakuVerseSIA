    ...
    <div id="app">
        ...
        <main class="container">
            <div class="hero-section">
                <h1 class="page-title">Discover Anime</h1>
                <p class="subtitle">Search for your favorite anime and add them to your watchlist!</p>
            ...
            <div class="content-section">
                <h2 id="results-title" class="section-title">Trending Anime</h2>
                
                <div id="loading-spinner" class="loading-spinner-container">
                    <div class="spinner-outer">
                        <div class="spinner-inner"></div>
                    </div>
                    <p class="loading-text">Loading anime...</p>
                </div>
